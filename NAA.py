...
tf.flags.DEFINE_string('output_dir', './outputs/outputs/', 'Output directory with images.')
                ...
                for i in range(num_iter):
                    if i==0:
                        ...
                        for l in range(int(FLAGS.ens)):
                            ...
                            images_tmp2 = image_preprocessing_fn(np.copy(images))
                            images_tmp2 += np.random.normal(size = images.shape, loc=0.0, scale=FLAGS.scale)
